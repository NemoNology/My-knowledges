...
{
	public int MaxSpeed { get; init; } = 42;
	public void Start() { ... }
	public void Stop() { ... }
}
...
public class Car
{
	public FastEngine Engine { get; init; } = new();
	...
}

// Чтобы не нарушать принцип инверсии зависимостей необходимо использовать абстракции (интерфейсы/абстрактные классы).
